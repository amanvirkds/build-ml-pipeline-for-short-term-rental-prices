# Instructions for the WandB and git

- Wandb: https://wandb.ai/amanvirk/nyc_airbnb
- git: https://github.com/amanvirkds/build-ml-pipeline-for-short-term-rental-prices.git
